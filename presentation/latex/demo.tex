...
\begin{document}
    ...
    % Use starred version (e.g. \section*{Section name}) to disable
    % (sub)section page. However, if you disable the page, the 
    % corresponding entry will _not_ appear in the table of contents. If you
    % want both an automatic ToC and no (sub)section page, you will have to
    % create the ToC manually.
